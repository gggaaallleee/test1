...
QT_MOC_LITERAL(5, 47, 20), // "on_addButton_clicked"
QT_MOC_LITERAL(6, 68, 21) // "on_chanButton_clicked"

    },
    "change\0display\0\0number\0on_returnButton_clicked\0"
    "on_addButton_clicked\0on_chanButton_clicked"
};
...
void change::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->on_chanButton_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (change::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&change::display)) {
                *result = 0;
                return;
            }
        }
