...
QT_MOC_LITERAL(5, 45, 23), // "on_jqfindButton_clicked"
QT_MOC_LITERAL(6, 69, 23), // "on_mhfindButton_clicked"
QT_MOC_LITERAL(7, 93, 25) // "on_xltjfindButton_clicked"

    },
    "Find\0display\0\0number\0on_returnButton_clicked\0"
    "on_jqfindButton_clicked\0on_mhfindButton_clicked\0"
    "on_xltjfindButton_clicked"
};
...
void Find::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_jqfindButton_clicked(); break;
        case 3: _t->on_mhfindButton_clicked(); break;
        case 4: _t->on_xltjfindButton_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Find::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Find::display)) {
                *result = 0;
                return;
            }
        }
